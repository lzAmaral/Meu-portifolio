      ...
      <section className="max-w-7xl mx-auto border-t border-gray-900 pt-24 pb-24">
        <div className="mb-16">
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter flex items-center gap-4">
            <span className="text-emerald-500 font-mono text-xl md:text-3xl">{"//"}</span> 
            Career_Log
          </h2>
        ...
        <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-800 before:to-transparent">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-[#050505] bg-emerald-500 text-[#050505] shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-[0_0_0_4px_#050505] z-10">
              <Terminal size={16} className="animate-pulse" />
            </div>
            
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-emerald-500/30 bg-[#0A0A0A] hover:bg-[#0c0c0c] transition-colors relative">
              <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-2 gap-2">
                ...
                <span className="text-emerald-500 font-mono text-xs border border-emerald-500/20 bg-emerald-500/10 px-2 py-1 shrink-0">2025 - Atual</span>
              </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
            <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-[#050505] bg-gray-800 text-gray-400 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow-[0_0_0_4px_#050505] z-10 group-hover:bg-emerald-500 group-hover:text-[#050505] transition-colors">
              <Terminal size={16} />
            </div>
            
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 border border-gray-900 bg-[#0A0A0A] hover:border-emerald-500/30 transition-colors relative">
              <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-2 gap-2">
